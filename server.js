...
const API_KEY = process.env.DARKSKY_API_KEY; //mengambil api key cuaca di file .env
const BASE_URL = `https://api.darksky.net/forecast`; //apikey yang digunakan berasal dari darksky
